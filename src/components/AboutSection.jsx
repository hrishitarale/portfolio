            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p>
                    Developing visually appealing and highly functional
                    websites.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p>
                    ...
                    Odio totam corporis deleniti incidunt fuga libero, eos modi.
                    Cumque, repellat dignissimos reiciendis commodi accusamus
                    dolorem maxime. Natus, reprehenderit amet! Harum, id?
                  </p>
                </div>
              </div>
            </div> */}
